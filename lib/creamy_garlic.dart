...
class CreamyGarlicScreen extends StatelessWidget {
  const CreamyGarlicScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (dish == null) {
      return Scaffold(
        appBar: AppBar(
          title: const Text('Creamy Garlic Spaghetti'),
          leading: IconButton(
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: DishDetailContent(
          dish: dish,
          ingredients: creamyGarlicDetails.ingredients,
