...
class AglioOlioScreen extends StatelessWidget {
  const AglioOlioScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (dish == null) {
      return Scaffold(
        appBar: AppBar(
          title: const Text('Spaghetti Aglio e Olio'),
          leading: IconButton(
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: DishDetailContent(
          dish: dish,
          ingredients: aglioOlioDetails.ingredients,
